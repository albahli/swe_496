                                ...
                                onPressed: () async {
                                  ...
                                  if (formKey.currentState.validate()) {
                                    ...
                                    try {
                                      ...
                                      bool userIsTaken = await DatabaseService()
                                          .checkIfUsernameIsTaken(
                                              _username); // Check if username is taken
                                      if (userIsTaken)
                                      ...
                                      setState(() {
                                        ...
                                        if (e.message ==
                                          ...
                                          error =
                                              'If you already have an account please tap here to sign in.';
                                          Get.snackbar(
                                            "The email address is registerd.",
                                            // title
                                            error, // message
                                            icon: Icon(
                                              Icons.error_outline,
