...
class _GroupProjectsViewState extends State<GroupProjectsView> {
 ...
 @override
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    onTap: () async {
                      Get.put<ProjectController>(ProjectController(projectID: snapshot.data.documents[index].documentID));
  ...
  void alertCreateProjectForm(BuildContext context) {
     List<String> deletelater = ['first' , 'second'];
    Alert(
        context: context,
              ...
              if (formKey.currentState.validate()) {
                try {
                  ProjectCollection().createNewProject(
                      _newProjectNameController.text, deletelater);
                  Get.back();
